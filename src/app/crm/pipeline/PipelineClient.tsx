...
export default function PipelineClient({ initial }: { initial: Lead[] }) {
  ...
  // The board arrives with the server's cards already on it; load() only runs
  // when a drop has to be re-read after a rejected move.
