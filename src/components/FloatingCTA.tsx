...
export default function FloatingCTA({ contact }: { contact: Contact }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 h-14 w-14 rounded-full bg-green-500 hover:bg-green-600 text-white shadow-2xl shadow-green-500/40 flex items-center justify-center transition hover:scale-110"
    >
